    ...
    public static void movePlayerSmoothly() {
        ...
        for (int i = 0; i < players.length; i++) {
            ...
            if (Math.abs(curr.getMoveIncrX()) >= SIZE || Math.abs(curr.getMoveIncrY()) >= SIZE) {
                ...
                else if (curr.isMovingDown() && curr.getRow() < board.length - 1 && board[curr.getRow() + 1][curr.getCol()] == false)
                    curr.setRow(curr.getRow() + 1);
                else if (curr.isMovingLeft() && curr.getCol() > 0 && board[curr.getRow()][curr.getCol() - 1] == false)
                    curr.setCol(curr.getCol() - 1);
                else if (curr.isMovingRight() && curr.getCol() < board[0].length - 1 && board[curr.getRow()][curr.getCol() + 1] == false)
                    curr.setCol(curr.getCol() + 1);
