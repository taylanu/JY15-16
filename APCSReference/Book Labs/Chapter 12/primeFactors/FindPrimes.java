...
public class FindPrimes {
    ...
    public static ArrayList<Integer> calcualteFactors(int number) {
    ...
    public static void main(String[] arg) {
        ...
        System.out.println(8 + ":" + calcualteFactors(8));
        myList.clear();
        System.out.println(60 + ":" + calcualteFactors(60));
        myList.clear();
        System.out.println(75 + ":" + calcualteFactors(75));
    }
}