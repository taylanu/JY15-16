...
public class TanksDriver                                //Driver Program
{
    ...
    public static class listen implements KeyListener {
        ...
        public void keyPressed(KeyEvent e) {//send key input to the Panel
        ...
        public void keyReleased(KeyEvent e) {
            ...
            {
                if (width < (screen.getCellSize() * 70) + (screen.getCellSize() * 10) && height < (screen.getCellSize() * 46) + (screen.getCellSize() * 4)) {                //battlefield size       +  menu screen size
