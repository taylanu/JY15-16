...
public class WorldBuilder extends TanksPanel {
    ...
    protected static void setUpGame() {
        ...
        if (Math.random() < .5) {    //since a changing terrain sometimes bottoms out, let random decide whether we build from right to left or left to right to even out the possibility of who has the high-ground
            for (int c = 0; c < board[0].length; c++)
